...
class ConstantPolynomial:
    ...
    def d(self, var: ConstantVariable) -> ConstantPolynomial:
...
class ConstantVariable(ConstantPolynomial):
    ...
    def __init__(self, ring: ConstantPolyRing, const_name: str):
...
class ConstantPolyRing(ConstantRing[ConstantPolynomial]):
    ...
    def get_constant(self, const_name: str) -> ConstantVariable:
